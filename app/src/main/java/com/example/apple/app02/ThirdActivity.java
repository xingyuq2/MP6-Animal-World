...
public class ThirdActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        title = new String[]{"crocodile", "lizard", "tortoise", "snake", "turtle"};
        images = new int[]{R.drawable.crocodile, R.drawable.lizard, R.drawable.tortoise, R.drawable.snake, R.drawable.turtle};
    ...
    private void initView() {
        mImage = findViewById(R.id.iv_show3);
        mText = findViewById(R.id.tv_show3);
